...
class Screens
{
    ...
    /**
     * Деньги «по-человечески»: до 2 знаков (как в кошельке), без хвостовых нулей,
     * с разделителем тысяч. 5000.00000 → «5 000», 5.77600 → «5.78», 20.82 → «20.82».
     * Внутри (списания/цены за номер) точность остаётся 5 знаков — округляем только вывод,
     * иначе баланс вида «5.776» читается как «5776».
     */
